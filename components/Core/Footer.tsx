      ...
      <div className='flex space-x-4'>
        ...
        <div style={{display:'flex', flexDirection:'column', marginLeft:'90px'}}>
            ...
            <div style={{display:'flex', flexDirection:'row', marginTop:'6px'}}>
              <Image src={ghn} alt="My Image" className = "w-20 h-12 mr-2 rounded" />
              <Image src={ghtk} alt="My Image" className = "w-20 h-12 mr-2 rounded" />
              <Image src={ems} alt="My Image" className = "w-20 h-12 mr-2 rounded" />
              <Image src={jandt} alt="My Image" className = "w-20 h-12 mr-2 rounded" />
            </div>
