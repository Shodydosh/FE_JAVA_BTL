...
const AddProductButton: React.FC = () => {
    ...
    const handleSubmitForm = () => {
        ...
        if (formValues.name === "" || formValues.img_url === "" || formValues.price === "") {
            message.error('Please fill in all required fields.')
            console.log("🚀 ~ file: AddProductButton.tsx:22 ~ handleSubmitForm ~ formValues:", formValues)
            return;
        }
                ...
                <Form layout="vertical">
                    ...
                    <Col span={20}>
                        <Form.Item
                            name="img_url"
                            label="Image Url"
                            rules={[{ required: true, message: 'Please enter img_url' }]}
                        >
                            <Input 
